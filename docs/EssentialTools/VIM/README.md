...
- [Neil, Drew. Practical Vim Edit Text at the Speed of Thought](./pdf/Practical.Vim.Edit.Text.at.the.Speed.of.Thought.(Z-Library).pdf)
- [Neil, Drew. Modern Vim: Craft Your Development Environment with Vim 8 and Neovim](./pdf/Modern.Vim.Craft.Your.Development.Environment.with.Vim.8.and.Neovim.(Z-Library).pdf)
